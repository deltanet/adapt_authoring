...
// Get the form field asset description
// Get the form field asset tags

// unzip


// loop through all of the files in the filestorage repository
// they could be any file type (do we want to exclude any?)

// need to create hash for each asset
