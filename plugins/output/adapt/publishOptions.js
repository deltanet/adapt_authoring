...
function publishOptions(courseId, mode, request, response, next) {
  var app = origin();
  var self = this;
  ...
  var trackingPlugin;
  var trackingPluginJson;

  if (request.body && request.body.trackingPlugin) {
    trackingPlugin = JSON.parse(request.body.trackingPlugin);
  }

  if (request.body && request.body.trackingPluginJson) {
    trackingPluginJson = JSON.parse(request.body.trackingPluginJson);
  }

console.log('trackingPlugin');
console.log(trackingPlugin);

console.log('trackingPluginJson');
console.log(trackingPluginJson);
