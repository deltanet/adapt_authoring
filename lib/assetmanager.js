    ...
    return {
      ...
      moduleLoaded : function (modloaded) {
        ...
        if(modloaded === WAITFOR){
          ...
          // set up routes
          // TODO - need upload asset zip endpoint
...
// TODO - unzip file to filestorage
  ...
  postAssetZip: function (req, res, next) {
    ...
    form.parse(req, function (error, fields, files) {
      ...
      filestorage.getStorage(repository, function (error, storage) {
        ...
        //logger.log('info', 'postAssetZip');
        //logger.log('info', 'Description: ' + globalFileDescription);
        //logger.log('info', 'Global Tags: ' + globalTags);
        ...
        ws.on('close', function () {
          ...
          fs.readdir(outputPath, function (err, files) {
            ...
            async.eachSeries(files, function(file, cb) {
              ...
              // TODO - should check it is a file
              ...
              if (fileStat.isFile()) {
                ...
                // TODO - need to get the actual file using fs.
            ...
            // need to capture error else return JSON
            //res.statusCode = 200;
...
//logger.log('info', JSON.stringify(file));
